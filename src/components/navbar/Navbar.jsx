    ...
    return (
        <div className="navbar">
            ...
            <div className="wrapper">
                <motion.span initial = {{opacity : 0, scale : 0.5}} animate = {{opacity : 1, scale : 1}} transition = {{duration:0.5}}>Mahantesh R Aralikatti</motion.span>
                <div className="social">
                    <a href="https://www.linkedin.com/in/mahantesh-r-aralikatti-349518277/"><img src="linkedin.png" alt="" /></a>
